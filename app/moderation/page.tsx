                                      ...
                                      {(edit.original?.photoUrls || []).length > 0 ? (
                                        edit.original?.photoUrls?.map((url, i) => (
                                          <img
                                            ...
                                            src={url}
                                            alt={`Photo ${i + 1}`}
                                            className="w-24 h-24 sm:w-32 sm:h-32 object-cover rounded-lg border border-red-800"
                                          />
                                        ))
                                      ) : (
                                      ...
                                      {(edit.changes.photoUrls || []).length > 0 ? (
                                        edit.changes.photoUrls?.map((url, i) => (
                                          <img
                                            ...
                                            src={url}
                                            alt={`Photo ${i + 1}`}
                                            className="w-24 h-24 sm:w-32 sm:h-32 object-cover rounded-lg border border-green-800"
                                          />
                                        ))
                                      ) : (
                                        <span className="text-gray-500 text-sm">Aucune photo</span>
